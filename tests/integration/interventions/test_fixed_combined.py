...
from offline_study.interventions.fixed_combined import CombinedFixedResponseIntervention
from offline_study.interventions.fixed_response import FixedResponseIntervention
...
class CombinedTests(unittest.TestCase):
    ...
    def test_private_prefix_exception_from_another_owner_is_not_swallowed(self):
        from offline_study.interventions.fixed_combined import _PrefixComplete
        backend, _, _, _, adapter = self.fixture()
