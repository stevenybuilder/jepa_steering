...
from offline_study.evaluation.checkpoint.author_validation import SOURCE_REVISION, approximate_standardized_mde, audit, official_clips, official_partition, require_disjoint_fit
from offline_study.models.vendor import use_vendor
from offline_study.evaluation.checkpoint.author_runtime import encoded_batches
...
class AuthorValidationTests(unittest.TestCase):
    ...
    @unittest.skipUnless((Path(__file__).resolve().parents[3] / "vendor/jepa-wms/app/plan_common/datasets/traj_dset.py").is_file(),
