...
from offline_study.runtime.compare import compare_runs
from offline_study.runtime.multigpu import aggregate_shards, benchmark_command, normalize_device
...
class MultiGpuTests(unittest.TestCase):
    def test_device_and_command_are_explicit(self):
        ...
        self.assertEqual(command[0:3], [__import__("sys").executable, "-m", "offline_study.runtime.benchmark"])
