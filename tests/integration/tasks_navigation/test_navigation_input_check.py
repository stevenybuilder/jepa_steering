...
from offline_study.tasks.droid.droid_native import assert_same
from offline_study.tasks.navigation.navigation_input_check import SelectedFrameSlicer, rng_state, restore_rng
