...
from offline_study.confirmation import SCENARIOS, ReservedGoalBank
from offline_study.fixed_response_behavior import ARMS, TASKS
from offline_study.fixed_response_behavior_analysis import analyze, validate_panel
...
class ConfirmationTests(unittest.TestCase):
    ...
    def test_real_reserved_inputs_all_hashes_and_schedule(self):
        root = Path(__file__).resolve().parents[1]/'artifacts/offline_study/primary-durable-20260907/planning-scenarios-20260907'
        if not root.is_dir():
