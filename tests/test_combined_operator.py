...
from offline_study.combined_contract import validate_contract
from offline_study.combined_operator import PAIRS, RECIPE_ARMS, remap_edits
from offline_study.interventions import CompiledEdit
from offline_study.combined_run import run_batch
...
class CombinedOperatorTests(unittest.TestCase):
    ...
    def test_dispatch_keeps_true_noops_and_source_singletons_separate(self):
        ...
        with patch("offline_study.combined_run.prepare_combined", return_value=(edits, [{}, {}], source)), \
                patch("offline_study.combined_run.PredictorIntervention", Hooks):
