...
from offline_study.experiments.decision_diagnostic import ARMS, TASKS, analyze, candidate_seed, rank_agreement, score_summary, validate_records
...
class DecisionDiagnosticTests(unittest.TestCase):
    ...
    def test_population_interception_restores_native_callback(self):
        import torch
        from offline_study.planning.decision_runtime import capture_population
        class Planner:
            def __init__(self):
