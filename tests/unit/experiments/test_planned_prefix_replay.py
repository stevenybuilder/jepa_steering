...
from offline_study.experiments import planned_prefix_replay as m
...
class PrefixContractTests(unittest.TestCase):
    def crop_fixture(self):
        path=Path(__file__).resolve().parents[3]/'vendor/jepa-wms/src/datasets/utils/video/transforms.py'
