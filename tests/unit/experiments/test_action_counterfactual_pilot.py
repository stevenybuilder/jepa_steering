...
from offline_study.experiments.action_counterfactual_pilot import ARMS, CounterfactualHook, action_range, private_seed, random_directions, reconstruction, replacement, swap_h3_actions, validate_protocol
...
def test_exact35_registry_and_protocol():
    protocol=json.loads((Path(__file__).parents[3]/'paper/data/action_counterfactual_protocol.json').read_text())
