...
from offline_study.evaluation.checkpoint.author_summary import CATEGORIES, COUNTS
...
from offline_study.tasks.pusht.verify_pusht_replica import verify as verify_pusht
