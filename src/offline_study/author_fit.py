...
from .action_geometry import central_estimates, collect_donors
from .author_runtime import AuthorBackend, encoded_batches, examples, open_normalized_dataset, prefix_batches, validate_cohort
from .geometry_fit import make_geometry_protocol
from .operator_fit import (NativeCouplingCapture, fit_coupled_directions, make_protocol,
                          orthogonal_random_control, permute_visual_direction, _model_versions)
from .protocol import sha256, write_json
from .support_fit import cpu_tree, make_support_protocol
...
def main():
    ...
    try:
        ...
        for category in ("vision_action_coupling", "action_response_geometry", *CATEGORIES):
            ...
            from .interventions import window_key
