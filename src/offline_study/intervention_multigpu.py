...
from .intervention_runner import summarize_interventions
from .multigpu import _stop_processes, normalize_device
...
def intervention_command(args, device: str, shard_index: int, num_shards: int) -> list[str]:
    return [
        sys.executable, "-m", "offline_study.intervention_runner",
