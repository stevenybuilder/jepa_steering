...
def main():
    ...
    from .fixed_combined_check import load_stimulus, assert_bytes, rng_signature
    ...
    if args.trace_cem:
        ...
        cem_report = {'native_only': True, 'iterations': len(trace.iterations),
                      ...
                      'observer_source_sha256': file_hash(Path(__file__).with_name('candidate_score_trace.py')),
