...
from offline_study.evaluation.fixed_response_behavior import ObservePlanner, device_uuid
from offline_study.validation.fixed_response_check import reference_fields
...
from offline_study.tasks.metaworld.metaworld_component_behavior import verify_energy
from offline_study.tasks.navigation.navigation_smoke import CHECKPOINTS as NAV_CHECKPOINTS, validate_complete
...
from offline_study.planning.planning_native_smoke import CHECKPOINTS as MW_CHECKPOINTS, run_episode
...
class CheckedObserver(ObservePlanner):
    ...
    def __call__(self, context, act_suffix=None, **kwargs):
        ...
        if self.engineering:
            from offline_study.experiments.fresh_engineering import context_shape_key, validate_all_arms
