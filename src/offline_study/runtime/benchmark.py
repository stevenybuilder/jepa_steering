...
from offline_study.models.backends import JepaBackend, ToyBackend
from offline_study.runtime.pipeline import AsyncCacheWriter, PrefetchIterator
from offline_study.core.protocol import sha256, shard_for, summarize_metrics, validate_manifest, window_starts, write_json
from offline_study.models.vendor import open_dataset
...
def main():
    ...
    try:
        ...
        report["harness_source_sha256"] = code_hash
        report["cache_files"] = [
