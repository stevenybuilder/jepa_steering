...
from .decision_diagnostic import ANALYSIS, ARMS, ROLE, TASKS, candidate_seed, score_summary
...
def freeze(args):
    from .behavioral_development import schedule
    from .fixed_response import load_fitted_bank
    from .fixed_response_behavior import coupling_binding, stimulus_contract
