...
from .behavioral_development import validate_coverage, verified_report
from .decision_runtime import source_binding
from .fixed_response import METHOD, FixedResponseIntervention, load_fitted_bank
from .fixed_response_behavior import (ANALYSIS, ARMS, CONTRASTS, TASKS, ObservePlanner,
    coupling_binding, device_uuid, frozen_protocol, verify_cem, verify_coupling_engineering)
from .fixed_response_behavior_analysis import analyze, validate_panel
from .fixed_response_smoke import trace_actor, verify_episode
from .intervention_runner import _model_versions
from .planning_contract import prepare, seed_schedule
from .planning_env_smoke import observation_digest
from .planning_goal_bank import GoalBank
...
def run(args):
    ...
    proof = verify_cem(args.engineering, fit, Path(__file__).parent, args.task)
