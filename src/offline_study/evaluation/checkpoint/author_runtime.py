...
from offline_study.evaluation.checkpoint.author_validation import CONFIGS, audit, official_partition, require_disjoint_fit
from offline_study.models.backends import JepaBackend
from offline_study.fitting.operator_fit import FIT_SEED, select_fit_rows
...
def validate_cohort(cohort):
    from offline_study.evaluation.checkpoint.author_access import validate_access
