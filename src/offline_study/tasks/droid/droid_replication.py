...
from offline_study.tasks.droid.droid_contract import checkpoint_score, prepare
from offline_study.tasks.droid.droid_native import full_episode, load_model, make_dataset, verified_report
...
def main():
    ...
    if (assets["status"] != "official_droid_inputs_staged_and_verified" or
            ...
            engineering_protocol["source_sha256"] != sha256(source_path("droid_native.py")) or
