...
from offline_study.data.dino3_prepare import SOURCE_COMMIT, WEIGHT_SHA256
from offline_study.tasks.droid.droid_assets import CHECKPOINT_SHA256, verify_download
from offline_study.tasks.droid.droid_contract import action_metrics, prepare
