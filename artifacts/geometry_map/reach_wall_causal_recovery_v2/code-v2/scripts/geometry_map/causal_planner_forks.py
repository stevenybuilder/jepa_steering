...
def reconstruct(cfg, wm, preprocessor, bank, replan_index):
...
def run(args):
    ...
    env, agent, z, checks = reconstruct(cfg, wm, preprocessor, bank, args.replan)
    ...
    for index, name in enumerate(names):
        env, _, _, replay_checks = reconstruct(cfg, wm, preprocessor, bank, args.replan)
    ...
    for arm in protocol["arms"]:
        ...
        env, agent, z, replay_checks = reconstruct(cfg, wm, preprocessor, bank, args.replan)
